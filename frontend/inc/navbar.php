...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
            <img src="/frontend/assets/img/logo.png" alt="Logo" class="logo-navbar">
            </div>
            <div class="col-xs-8">
    ...
    <div class="modal fade modal-login" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="false">
...
<div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg" inert>
    <br>
    <h3 class="text-center tittles-pages-logo">UNIÓN XIOMARA</h3>
...
<div class="modal fade" id="ModalUpUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-modal="true">
...
<!-- Script para manejar inert correctamente -->
<script>
// Cuando el modal se abra, quitamos 'inert' del modal y se lo ponemos al resto del contenido
$(document).ready(function(){
    var modal = document.getElementById('ModalUpUser');
    var background = document.getElementById('mobile-menu-list');

    $('#ModalUpUser').on('shown.bs.modal', function () {
        background.setAttribute('inert', '');
        modal.removeAttribute('inert');
    });

    $('#ModalUpUser').on('hidden.bs.modal', function () {
...
<!-- Polyfill para navegadores antiguos que no soportan 'inert' -->
