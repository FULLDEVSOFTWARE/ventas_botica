       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">UNIÓN XIOMARA</small></h1>
            </div>
            <?php
              ...
              <div class="row">
                ...
                ?>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                         <div class="thumbnail">
                           <img class="img-product" src="../frontend/assets/img-products/<?php if($prod['Imagen']!="" && is_file("../frontend/assets/img-products/".$prod['Imagen'])){ echo $prod['Imagen']; }else{ echo "default.png"; } ?>
                           ">
                           <div class="caption">
