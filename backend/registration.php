<?php
// No changes to PHP includes here, just fixing the includes paths
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">UNIÓN XIOMARA</small></h1>
            </div>
            
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="../frontend/assets/img/logo-2.png" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
