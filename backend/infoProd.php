        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>DETALLE DE PRODUCTO <small class="tittles-pages-logo">UNIÓN XIOMARA</small></h1>
                </div>
                <?php 
                    ...
                    while($fila=mysqli_fetch_array($productoinfo, MYSQLI_ASSOC)){
                        echo '
                            <div class="col-xs-12 col-sm-6">
                                ...
                                if($fila['Imagen']!="" && is_file("../frontend/assets/img-products/".$fila['Imagen'])){ 
                                    $imagenFile="../frontend/assets/img-products/".$fila['Imagen']; 
                                }else{ 
                                    $imagenFile="../frontend/assets/img-products/default.png"; 
                                }
                                echo '<br>
